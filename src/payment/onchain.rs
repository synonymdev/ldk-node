...
impl OnchainPayment {
	...
	///
	/// The address type must be configured as the primary address type or included in
	/// `address_types_to_monitor` when building the node.
