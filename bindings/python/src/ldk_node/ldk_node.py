...
def _uniffi_check_api_checksums(lib):
    ...
    if lib.uniffi_ldk_node_checksum_method_bolt12payment_set_paths_to_static_invoice_server() != 20921:
        raise InternalError("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    if lib.uniffi_ldk_node_checksum_method_builder_build() != 64768:
        raise InternalError("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    if lib.uniffi_ldk_node_checksum_method_builder_build_with_fs_store() != 42069:
        raise InternalError("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    if lib.uniffi_ldk_node_checksum_method_builder_build_with_vss_store() != 29149:
        raise InternalError("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    if lib.uniffi_ldk_node_checksum_method_builder_build_with_vss_store_and_fixed_headers() != 64024:
        raise InternalError("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    if lib.uniffi_ldk_node_checksum_method_builder_build_with_vss_store_and_header_provider() != 54133:
        raise InternalError("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    ...
    if lib.uniffi_ldk_node_checksum_constructor_feerate_from_sat_per_vb_unchecked() != 41808:
        raise InternalError("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    if lib.uniffi_ldk_node_checksum_constructor_nodeentropy_from_bip39_mnemonic() != 14993:
        raise InternalError("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    if lib.uniffi_ldk_node_checksum_constructor_nodeentropy_from_seed_bytes() != 45223:
        raise InternalError("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    if lib.uniffi_ldk_node_checksum_constructor_nodeentropy_from_seed_path() != 56835:
        raise InternalError("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
...
_UniffiLib.uniffi_ldk_node_fn_clone_nodeentropy.argtypes = (
    ctypes.c_void_p,
    ctypes.POINTER(_UniffiRustCallStatus),
)
_UniffiLib.uniffi_ldk_node_fn_clone_nodeentropy.restype = ctypes.c_void_p
_UniffiLib.uniffi_ldk_node_fn_free_nodeentropy.argtypes = (
    ctypes.c_void_p,
    ctypes.POINTER(_UniffiRustCallStatus),
)
_UniffiLib.uniffi_ldk_node_fn_free_nodeentropy.restype = None
_UniffiLib.uniffi_ldk_node_fn_constructor_nodeentropy_from_bip39_mnemonic.argtypes = (
    _UniffiRustBuffer,
    _UniffiRustBuffer,
    ctypes.POINTER(_UniffiRustCallStatus),
)
_UniffiLib.uniffi_ldk_node_fn_constructor_nodeentropy_from_bip39_mnemonic.restype = ctypes.c_void_p
_UniffiLib.uniffi_ldk_node_fn_constructor_nodeentropy_from_seed_bytes.argtypes = (
    _UniffiRustBuffer,
    ctypes.POINTER(_UniffiRustCallStatus),
)
_UniffiLib.uniffi_ldk_node_fn_constructor_nodeentropy_from_seed_bytes.restype = ctypes.c_void_p
_UniffiLib.uniffi_ldk_node_fn_constructor_nodeentropy_from_seed_path.argtypes = (
    _UniffiRustBuffer,
    ctypes.POINTER(_UniffiRustCallStatus),
)
_UniffiLib.uniffi_ldk_node_fn_constructor_nodeentropy_from_seed_path.restype = ctypes.c_void_p
...
_UniffiLib.uniffi_ldk_node_checksum_constructor_nodeentropy_from_bip39_mnemonic.argtypes = (
)
_UniffiLib.uniffi_ldk_node_checksum_constructor_nodeentropy_from_bip39_mnemonic.restype = ctypes.c_uint16
_UniffiLib.uniffi_ldk_node_checksum_constructor_nodeentropy_from_seed_bytes.argtypes = (
)
_UniffiLib.uniffi_ldk_node_checksum_constructor_nodeentropy_from_seed_bytes.restype = ctypes.c_uint16
_UniffiLib.uniffi_ldk_node_checksum_constructor_nodeentropy_from_seed_path.argtypes = (
)
_UniffiLib.uniffi_ldk_node_checksum_constructor_nodeentropy_from_seed_path.restype = ctypes.c_uint16
...
class BuilderProtocol(typing.Protocol):
    def build(self, node_entropy: "NodeEntropy"):
        raise NotImplementedError
    def build_with_fs_store(self, node_entropy: "NodeEntropy"):
        raise NotImplementedError
    def build_with_vss_store(self, node_entropy: "NodeEntropy",vss_url: "str",store_id: "str",lnurl_auth_server_url: "str",fixed_headers: "dict[str, str]"):
        raise NotImplementedError
    def build_with_vss_store_and_fixed_headers(self, node_entropy: "NodeEntropy",vss_url: "str",store_id: "str",fixed_headers: "dict[str, str]"):
        raise NotImplementedError
    def build_with_vss_store_and_header_provider(self, node_entropy: "NodeEntropy",vss_url: "str",store_id: "str",header_provider: "VssHeaderProvider"):
        raise NotImplementedError
...
class Builder:
    ...
    def build(self, node_entropy: "NodeEntropy") -> "Node":
        _UniffiConverterTypeNodeEntropy.check_lower(node_entropy)
        ...
        _UniffiConverterTypeNodeEntropy.lower(node_entropy))
        )
    ...
    def build_with_fs_store(self, node_entropy: "NodeEntropy") -> "Node":
        _UniffiConverterTypeNodeEntropy.check_lower(node_entropy)
    ...
    def build_with_vss_store(self, node_entropy: "NodeEntropy",vss_url: "str",store_id: "str",lnurl_auth_server_url: "str",fixed_headers: "dict[str, str]") -> "Node":
        _UniffiConverterTypeNodeEntropy.check_lower(node_entropy)
    ...
    def build_with_vss_store_and_fixed_headers(self, node_entropy: "NodeEntropy",vss_url: "str",store_id: "str",fixed_headers: "dict[str, str]") -> "Node":
        _UniffiConverterTypeNodeEntropy.check_lower(node_entropy)
    ...
    def build_with_vss_store_and_header_provider(self, node_entropy: "NodeEntropy",vss_url: "str",store_id: "str",header_provider: "VssHeaderProvider") -> "Node":
        _UniffiConverterTypeNodeEntropy.check_lower(node_entropy)
...
class NodeEntropyProtocol(typing.Protocol):
    pass
...
class NodeEntropy:
    ...
    def __del__(self):
        ...
        pointer = getattr(self, "_pointer", None)
        if pointer is not None:
            _uniffi_rust_call(_UniffiLib.uniffi_ldk_node_fn_free_nodeentropy, pointer)

    def _uniffi_clone_pointer(self):
        return _uniffi_rust_call(_UniffiLib.uniffi_ldk_node_fn_clone_nodeentropy, self._pointer)
    ...
    def _make_instance_(cls, pointer):
        ...
        return inst
    @classmethod
    def from_bip39_mnemonic(cls, mnemonic: "Mnemonic",passphrase: "typing.Optional[str]"):
        _UniffiConverterTypeMnemonic.check_lower(mnemonic)
        
        _UniffiConverterOptionalString.check_lower(passphrase)
        
        # Call the (fallible) function before creating any half-baked object instances.
        pointer = _uniffi_rust_call(_UniffiLib.uniffi_ldk_node_fn_constructor_nodeentropy_from_bip39_mnemonic,
    ...
    def from_seed_bytes(cls, seed_bytes: "bytes"):
        ...
        # Call the (fallible) function before creating any half-baked object instances.
        pointer = _uniffi_rust_call_with_error(_UniffiConverterTypeEntropyError,_UniffiLib.uniffi_ldk_node_fn_constructor_nodeentropy_from_seed_bytes,
        _UniffiConverterBytes.lower(seed_bytes))
        return cls._make_instance_(pointer)

    @classmethod
    def from_seed_path(cls, seed_path: "str"):
        _UniffiConverterString.check_lower(seed_path)
        
        # Call the (fallible) function before creating any half-baked object instances.
        pointer = _uniffi_rust_call_with_error(_UniffiConverterTypeEntropyError,_UniffiLib.uniffi_ldk_node_fn_constructor_nodeentropy_from_seed_path,
...
class _UniffiConverterTypeNodeEntropy:

    @staticmethod
    def lift(value: int):
        return NodeEntropy._make_instance_(value)

    @staticmethod
    def check_lower(value: NodeEntropy):
        if not isinstance(value, NodeEntropy):
            raise TypeError("Expected NodeEntropy instance, {} found".format(type(value).__name__))

    @staticmethod
    def lower(value: NodeEntropyProtocol):
        if not isinstance(value, NodeEntropy):
            raise TypeError("Expected NodeEntropy instance, {} found".format(type(value).__name__))
        return value._uniffi_clone_pointer()
    ...
    @classmethod
    def write(cls, value: NodeEntropyProtocol, buf: _UniffiRustBuffer):
        buf.write_u64(cls.lower(value))
...
_UniffiTempEntropyError = EntropyError

class EntropyError:  # type: ignore
    class InvalidSeedBytes(_UniffiTempEntropyError):

        def __repr__(self):
            return "EntropyError.InvalidSeedBytes({})".format(repr(str(self)))
    _UniffiTempEntropyError.InvalidSeedBytes = InvalidSeedBytes # type: ignore
    class InvalidSeedFile(_UniffiTempEntropyError):

        def __repr__(self):
            return "EntropyError.InvalidSeedFile({})".format(repr(str(self)))
    _UniffiTempEntropyError.InvalidSeedFile = InvalidSeedFile # type: ignore

EntropyError = _UniffiTempEntropyError # type: ignore
del _UniffiTempEntropyError


class _UniffiConverterTypeEntropyError(_UniffiConverterRustBuffer):
    @staticmethod
    def read(buf):
        variant = buf.read_i32()
        if variant == 1:
            return EntropyError.InvalidSeedBytes(
                _UniffiConverterString.read(buf),
            )
        if variant == 2:
            return EntropyError.InvalidSeedFile(
                _UniffiConverterString.read(buf),
            )
        raise InternalError("Raw enum value doesn't match any cases")
    ...
    @staticmethod
    def check_lower(value):
        if isinstance(value, EntropyError.InvalidSeedBytes):
            return
        if isinstance(value, EntropyError.InvalidSeedFile):
            return
