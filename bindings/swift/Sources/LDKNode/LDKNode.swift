...
open func sendProbes(invoice: Bolt11Invoice, routeParameters: RouteParametersConfig?)throws  -> [ProbeHandle] {
    return try  FfiConverterSequenceTypeProbeHandle.lift(try rustCallWithError(FfiConverterTypeNodeError.lift) {
...
open func getBalanceForAddressType(addressType: AddressType)throws  -> AddressTypeBalance {
    return try  FfiConverterTypeAddressTypeBalance.lift(try rustCallWithError(FfiConverterTypeNodeError.lift) {
...
open func addressInfoForAccountAtIndex(addressType: AddressType, accountIndex: UInt32, keychain: KeychainKind, index: UInt32)throws  -> AddressInfo {
    return try  FfiConverterTypeAddressInfo.lift(try rustCallWithError(FfiConverterTypeNodeError.lift) {
...
open func addressInfosForAccount(addressType: AddressType, accountIndex: UInt32, keychain: KeychainKind, startIndex: UInt32, count: UInt32)throws  -> [AddressInfo] {
    return try  FfiConverterSequenceTypeAddressInfo.lift(try rustCallWithError(FfiConverterTypeNodeError.lift) {
...
public struct FfiConverterTypeBuildError: FfiConverterRustBuffer {
    ...
    public static func read(from buf: inout (data: Data, offset: Data.Index)) throws -> BuildError {
        ...
        case 10: return .DangerousValue(
            message: try FfiConverterString.read(from: &buf)
        )
        
        case 11: return .WriteFailed(
            message: try FfiConverterString.read(from: &buf)
        )
        
        case 12: return .StoragePathAccessFailed(
            message: try FfiConverterString.read(from: &buf)
        )
        
        case 13: return .KvStoreSetupFailed(
            message: try FfiConverterString.read(from: &buf)
        )
        
        case 14: return .WalletSetupFailed(
            message: try FfiConverterString.read(from: &buf)
        )
        
        case 15: return .LoggerSetupFailed(
            message: try FfiConverterString.read(from: &buf)
        )
        
        case 16: return .NetworkMismatch(
            message: try FfiConverterString.read(from: &buf)
        )
        
        case 17: return .AsyncPaymentsConfigMismatch(
            message: try FfiConverterString.read(from: &buf)
        )
...
public struct FfiConverterTypeEvent: FfiConverterRustBuffer {
    ...
    public static func read(from buf: inout (data: Data, offset: Data.Index)) throws -> Event {
        ...
        case 6: return .probeSuccessful(paymentId: try FfiConverterTypePaymentId.read(from: &buf), paymentHash: try FfiConverterTypePaymentHash.read(from: &buf), routeFeeMsat: try FfiConverterOptionUInt64.read(from: &buf)
        )
        
        case 7: return .probeFailed(paymentId: try FfiConverterTypePaymentId.read(from: &buf), paymentHash: try FfiConverterTypePaymentHash.read(from: &buf), shortChannelId: try FfiConverterOptionUInt64.read(from: &buf), routeFeeMsat: try FfiConverterOptionUInt64.read(from: &buf)
        )
        
        case 8: return .channelPending(channelId: try FfiConverterTypeChannelId.read(from: &buf), userChannelId: try FfiConverterTypeUserChannelId.read(from: &buf), formerTemporaryChannelId: try FfiConverterTypeChannelId.read(from: &buf), counterpartyNodeId: try FfiConverterTypePublicKey.read(from: &buf), fundingTxo: try FfiConverterTypeOutPoint.read(from: &buf)
        )
        
        case 9: return .channelReady(channelId: try FfiConverterTypeChannelId.read(from: &buf), userChannelId: try FfiConverterTypeUserChannelId.read(from: &buf), counterpartyNodeId: try FfiConverterOptionTypePublicKey.read(from: &buf), fundingTxo: try FfiConverterOptionTypeOutPoint.read(from: &buf)
        )
        
        case 10: return .channelClosed(channelId: try FfiConverterTypeChannelId.read(from: &buf), userChannelId: try FfiConverterTypeUserChannelId.read(from: &buf), counterpartyNodeId: try FfiConverterOptionTypePublicKey.read(from: &buf), reason: try FfiConverterOptionTypeClosureReason.read(from: &buf)
        )
        
        case 11: return .splicePending(channelId: try FfiConverterTypeChannelId.read(from: &buf), userChannelId: try FfiConverterTypeUserChannelId.read(from: &buf), counterpartyNodeId: try FfiConverterTypePublicKey.read(from: &buf), newFundingTxo: try FfiConverterTypeOutPoint.read(from: &buf)
        )
        
        case 12: return .spliceFailed(channelId: try FfiConverterTypeChannelId.read(from: &buf), userChannelId: try FfiConverterTypeUserChannelId.read(from: &buf), counterpartyNodeId: try FfiConverterTypePublicKey.read(from: &buf), abandonedFundingTxo: try FfiConverterOptionTypeOutPoint.read(from: &buf)
        )
        
        case 13: return .onchainTransactionConfirmed(txid: try FfiConverterTypeTxid.read(from: &buf), blockHash: try FfiConverterTypeBlockHash.read(from: &buf), blockHeight: try FfiConverterUInt32.read(from: &buf), confirmationTime: try FfiConverterUInt64.read(from: &buf), details: try FfiConverterTypeTransactionDetails.read(from: &buf)
        )
        
        case 14: return .onchainTransactionReceived(txid: try FfiConverterTypeTxid.read(from: &buf), details: try FfiConverterTypeTransactionDetails.read(from: &buf)
        )
        
        case 15: return .onchainTransactionReplaced(txid: try FfiConverterTypeTxid.read(from: &buf), conflicts: try FfiConverterSequenceTypeTxid.read(from: &buf)
        )
        
        case 16: return .onchainTransactionReorged(txid: try FfiConverterTypeTxid.read(from: &buf)
        )
        
        case 17: return .onchainTransactionEvicted(txid: try FfiConverterTypeTxid.read(from: &buf)
        )
        
        case 18: return .syncProgress(syncType: try FfiConverterTypeSyncType.read(from: &buf), progressPercent: try FfiConverterUInt8.read(from: &buf), currentBlockHeight: try FfiConverterUInt32.read(from: &buf), targetBlockHeight: try FfiConverterUInt32.read(from: &buf)
        )
        
        case 19: return .syncCompleted(syncType: try FfiConverterTypeSyncType.read(from: &buf), syncedBlockHeight: try FfiConverterUInt32.read(from: &buf)
        )
        
        case 20: return .balanceChanged(oldSpendableOnchainBalanceSats: try FfiConverterUInt64.read(from: &buf), newSpendableOnchainBalanceSats: try FfiConverterUInt64.read(from: &buf), oldTotalOnchainBalanceSats: try FfiConverterUInt64.read(from: &buf), newTotalOnchainBalanceSats: try FfiConverterUInt64.read(from: &buf), oldTotalLightningBalanceSats: try FfiConverterUInt64.read(from: &buf), newTotalLightningBalanceSats: try FfiConverterUInt64.read(from: &buf)
        )
...
@_documentation(visibility: private)
#endif
fileprivate struct FfiConverterOptionTypeScoringDecayParameters: FfiConverterRustBuffer {
...
@_documentation(visibility: private)
#endif
fileprivate struct FfiConverterOptionTypeScoringFeeParameters: FfiConverterRustBuffer {
...
@_documentation(visibility: private)
#endif
fileprivate struct FfiConverterSequenceTypeOnchainWalletAccount: FfiConverterRustBuffer {
    ...
    public static func read(from buf: inout (data: Data, offset: Data.Index)) throws -> [OnchainWalletAccount] {
        ...
        seq.reserveCapacity(Int(len))
        for _ in 0 ..< len {
            seq.append(try FfiConverterTypeOnchainWalletAccount.read(from: &buf))
        }
        return seq
    }
}
...
@_documentation(visibility: private)
#endif
fileprivate struct FfiConverterSequenceTypeOnchainWalletAccountConfig: FfiConverterRustBuffer {
    ...
    public static func read(from buf: inout (data: Data, offset: Data.Index)) throws -> [OnchainWalletAccountConfig] {
        ...
        seq.reserveCapacity(Int(len))
        for _ in 0 ..< len {
            seq.append(try FfiConverterTypeOnchainWalletAccountConfig.read(from: &buf))
        }
        return seq
    }
}
...
@_documentation(visibility: private)
#endif
fileprivate struct FfiConverterSequenceTypeProbeHandle: FfiConverterRustBuffer {
    ...
    public static func read(from buf: inout (data: Data, offset: Data.Index)) throws -> [ProbeHandle] {
        ...
        seq.reserveCapacity(Int(len))
        for _ in 0 ..< len {
            seq.append(try FfiConverterTypeProbeHandle.read(from: &buf))
        }
        return seq
    }
}
...
@_documentation(visibility: private)
#endif
fileprivate struct FfiConverterSequenceTypeAddressType: FfiConverterRustBuffer {
    typealias SwiftType = [AddressType]
    ...
    public static func read(from buf: inout (data: Data, offset: Data.Index)) throws -> [AddressType] {
        ...
        seq.reserveCapacity(Int(len))
        for _ in 0 ..< len {
            seq.append(try FfiConverterTypeAddressType.read(from: &buf))
        }
        return seq
    }
}
...
public func deriveNodeSecretFromMnemonic(mnemonic: String, passphrase: String?)throws  -> [UInt8] {
    return try  FfiConverterSequenceUInt8.lift(try rustCallWithError(FfiConverterTypeNodeError.lift) {
