    ...
    NodeEntropyProtocol
{
    ...
    public static func fromSeedBytes(seedBytes: Data) throws -> NodeEntropy {
        return try FfiConverterTypeNodeEntropy.lift(rustCallWithError(FfiConverterTypeEntropyError.lift) {
...
public struct FfiConverterTypeBuildError: FfiConverterRustBuffer {
    ...
    public static func read(from buf: inout (data: Data, offset: Data.Index)) throws -> BuildError {
        let variant: Int32 = try readInt(&buf)
        switch variant {
        case 1: return try .InvalidSystemTime(
                message: FfiConverterString.read(from: &buf)
            )

        case 2: return try .InvalidChannelMonitor(
                message: FfiConverterString.read(from: &buf)
            )

        case 3: return try .InvalidListeningAddresses(
                message: FfiConverterString.read(from: &buf)
            )

        case 4: return try .InvalidAnnouncementAddresses(
                message: FfiConverterString.read(from: &buf)
            )

        case 5: return try .InvalidNodeAlias(
                message: FfiConverterString.read(from: &buf)
            )

        case 6: return try .RuntimeSetupFailed(
                message: FfiConverterString.read(from: &buf)
            )
        ...
        case 13: return try .NetworkMismatch(
                message: FfiConverterString.read(from: &buf)
            )

        case 14: return try .AsyncPaymentsConfigMismatch(
                message: FfiConverterString.read(from: &buf)
            )
