...
open class Builder: Disposable, BuilderInterface {
    ...
    @Throws(BuildException::class)
    override fun `buildWithVssStore`(`nodeEntropy`: NodeEntropy, `vssUrl`: kotlin.String, `storeId`: kotlin.String, `lnurlAuthServerUrl`: kotlin.String, `fixedHeaders`: Map<kotlin.String, kotlin.String>): Node {
        return FfiConverterTypeNode.lift(callWithPointer {
            uniffiRustCallWithError(BuildExceptionErrorHandler) { uniffiRustCallStatus ->
    ...
    @Throws(BuildException::class)
    override fun `buildWithVssStoreAndFixedHeaders`(`nodeEntropy`: NodeEntropy, `vssUrl`: kotlin.String, `storeId`: kotlin.String, `fixedHeaders`: Map<kotlin.String, kotlin.String>): Node {
        return FfiConverterTypeNode.lift(callWithPointer {
            uniffiRustCallWithError(BuildExceptionErrorHandler) { uniffiRustCallStatus ->
    ...
    @Throws(BuildException::class)
    override fun `buildWithVssStoreAndHeaderProvider`(`nodeEntropy`: NodeEntropy, `vssUrl`: kotlin.String, `storeId`: kotlin.String, `headerProvider`: VssHeaderProvider): Node {
        return FfiConverterTypeNode.lift(callWithPointer {
            uniffiRustCallWithError(BuildExceptionErrorHandler) { uniffiRustCallStatus ->
...
open class NodeEntropy: Disposable, NodeEntropyInterface {
    ...
    companion object {
        ...
        fun `fromBip39Mnemonic`(`mnemonic`: Mnemonic, `passphrase`: kotlin.String?): NodeEntropy {
            return FfiConverterTypeNodeEntropy.lift(uniffiRustCall { uniffiRustCallStatus ->
        ...
        fun `fromSeedBytes`(`seedBytes`: kotlin.ByteArray): NodeEntropy {
            return FfiConverterTypeNodeEntropy.lift(uniffiRustCallWithError(EntropyExceptionErrorHandler) { uniffiRustCallStatus ->
...
object FfiConverterTypeNodeEntropy: FfiConverter<NodeEntropy, Pointer> {
...
object EntropyExceptionErrorHandler : UniffiRustCallStatusErrorHandler<EntropyException> {
    override fun lift(errorBuf: RustBufferByValue): EntropyException = FfiConverterTypeEntropyError.lift(errorBuf)
}

object FfiConverterTypeEntropyError : FfiConverterRustBuffer<EntropyException> {
